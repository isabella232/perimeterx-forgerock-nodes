...
public interface PBKDF2 {
    ...
    /**
     * Set the Pseudo Random Function to use. Note that deriveKeys/getPRF does init
     * this object using the supplied candidate password. If this is undesired, one
     * has to override getPRF.
     *
