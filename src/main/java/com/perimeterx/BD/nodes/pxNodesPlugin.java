 ...
 * "https://backstage.forgerock.com/docs/am/6/apidocs/org/forgerock/openam/auth/node/api/AbstractNodeAmPlugin.html">AbstractNodeAmPlugin</a>.
 ...
 * <a href=
 * "https://backstage.forgerock.com/docs/am/6/apidocs/org/forgerock/openam/plugins/PluginTools.html#addSmsService-java.io.InputStream-">here</a>
 * <p>
 * It can be assumed that when running, implementations of this class will be
 * singleton instances.
 * </p>
 * <p>
 * It should <i>not</i> be expected that the runtime singleton instances will be
 * the instances on which
 * {@link #onAmUpgrade(String, String)} will be called. Guice-injected
 * properties will also <i>not</i> be populated
 * during that method call.
 * </p>
 * <p>
 * Plugins should <i>not</i> use the
 * {@code ShutdownManager}/{@code ShutdownListener} API for handling shutdown,
 * as
 * the order of calling those listeners is not deterministic. The
 * {@link #onShutdown()} method for all plugins will
 * be called in the reverse order from the order that {@link #onStartup()} was
